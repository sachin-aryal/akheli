...
?>
    ...
    <!---->
    <!--        <div class="item">-->
    <!--            <img src="public/img/4.png" alt="New york">-->
    <!--        </div>-->
    <!--    </div>-->
    ...
    <div class="container-fluid">
        <div class="row margin-vertical shadow">
            ...
            <div class="col-md-11 no-padding">
                <form class="general-search-form" method="post" action="searchResult.php">
                    <div class="form-group no-margin">
                        <input type="search" class="form-control text-center" name="search" id="search" placeholder="Search product here...">
                    </div>
                </form>
            </div>
